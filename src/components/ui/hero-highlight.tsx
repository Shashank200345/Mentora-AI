...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-screen w-full items-center justify-center bg-[var(--bg-100)] dark:bg-[var(--bg-100)]",
        containerClassName,
      )}
      onMouseMove={handleMouseMove}
    >
      {/* Bottom shadow gradient */}
      <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-black/25 via-black/15 to-transparent pointer-events-none" />
      ...
      />
      <motion.div
        className="pointer-events-none absolute inset-0 hidden opacity-0 transition duration-300 group-hover:opacity-50 dark:block"
        style={{
